...
Router.route('/quiz/:continent', {
    ...
    data:function(){
//        Session.set('selectedContinent', this.params.continent);
//        var questions = Questions.find({quizQuestionDisplayed:false,continent:this.params.continent},{question:1,optA:1,optB:1,optC:1,answer:1,continent:1});    
        
        var questions = Questions.findOne({quizQuestionDisplayed:false,continent:this.params.continent});
        console.log(questions);
        return questions;
//        if(questions !== (undefined || null)){
//            var continentQuestions = [questions.collection._docs._map ];
//             console.log(continentQuestions[0]);
//            var ids = Object.keys(continentQuestions[0]);
//             return Session.set('ids',ids);
//          if(ids !== 0){          
            // console.log(ids);
...
//        }
        ...
        //   selectedContinent:this.params.continent
    }
    
});


Router.route('/quiz',{name:'quizHome'});
