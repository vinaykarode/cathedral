...
//        console.log(questions);
    if(questions !== null && questions !== undefined){
        ...
        Session.set('selectedID', questions._id);
...
Router.route('/quiz',{
    ...
    data:function(){
        ...
        Session.set('counterStarted',0);
        Session.set('score',0);
        Session.set('questionsDisplayed', 0); //counter to keep track of the number of questions displayed.
        Session.set('scoreChanged', 1); //dont load new question untill score changes
        Session.set('playerNameEntered', 0); // check if name entered in leaderboard form
        Session.set('rank',0);
...
Router.route('/leaderboard',{
    name:'leaderboard',
    waitOn:function(){
      return Meteor.subscribe('leaderboard', Session.get('selectedContinent'))  
    },
    data:function(){
        return Leaderboard.find({continent:Session.get('selectedContinent')});
    }
})
